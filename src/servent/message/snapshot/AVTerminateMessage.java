...
public class AVTerminateMessage extends BasicMessage {
	...
	public AVTerminateMessage(MessageType type, ServentInfo originalSenderInfo, ServentInfo receiverInfo, ServentInfo targetInfo,
			Map<Integer, Integer> vectorClock) {
		super(type, originalSenderInfo, receiverInfo, targetInfo, vectorClock);
	}
	

	protected AVTerminateMessage(MessageType messageType, ServentInfo originalSenderInfo, ServentInfo newReceiverInfo,
	...
	public Message changeReceiver(Integer newReceiverId) {
		if (AppConfig.myServentInfo.getNeighbors().contains(newReceiverId) || AppConfig.myServentInfo.getId() == newReceiverId) {
			...
			Message toReturn = new AVTerminateMessage(getMessageType(), getOriginalSenderInfo(),
